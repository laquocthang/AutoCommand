namespace AutoCommand
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.tbx_PY = new System.Windows.Forms.TextBox();
			this.tbx_PX = new System.Windows.Forms.TextBox();
			...
			this.cbx_FontStyle = new System.Windows.Forms.ComboBox();
			...
			this.chk_Format = new System.Windows.Forms.CheckBox();
			this.chk_Diacritical = new System.Windows.Forms.CheckBox();
			...
			// tabPage2
			// 
			this.tabPage2.Controls.Add(this.btn_Review);
			this.tabPage2.Controls.Add(this.btn_ChoosenColor);
			this.tabPage2.Controls.Add(this.label15);
			this.tabPage2.Controls.Add(this.label14);
			this.tabPage2.Controls.Add(this.tbx_PY);
			this.tabPage2.Controls.Add(this.tbx_PX);
			...
			this.tabPage2.Controls.Add(this.cbx_FontStyle);
			...
			this.btn_ChoosenColor.Text = "Choose...";
			this.btn_ChoosenColor.UseVisualStyleBackColor = true;
			this.btn_ChoosenColor.Click += new System.EventHandler(this.btn_ChoosenColor_Click);
			// 
			// label15
			// 
			...
			this.cbx_FontStyle.Text = "Regular";
			// 
			// label10
			// 
			...
			this.tabPage1.Size = new System.Drawing.Size(826, 461);
			this.tabPage1.TabIndex = 0;
			this.tabPage1.Text = "Multi-Rename Tool";
			...
			this.btn_Browse1.Location = new System.Drawing.Point(136, 6);
			this.btn_Browse1.Name = "btn_Browse1";
			this.btn_Browse1.Size = new System.Drawing.Size(110, 25);
			...
			this.btn_Start1.Location = new System.Drawing.Point(705, 100);
			...
			this.dataGridView1.Size = new System.Drawing.Size(809, 285);
			...
			this.groupBox5.Location = new System.Drawing.Point(705, 6);
			...
			this.cbx_Digits.SelectedIndexChanged += new System.EventHandler(this.cbx_Digits_SelectedIndexChanged);
			// 
			// label5
			// 
			...
			this.groupBox4.Location = new System.Drawing.Point(499, 81);
			...
			// tbx_Find
			// 
			this.tbx_Find.Location = new System.Drawing.Point(95, 17);
			...
			this.tbx_Extension.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.tbx_Extension_KeyPress);
			// 
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.chk_Format);
			this.groupBox1.Controls.Add(this.chk_Diacritical);
			...
			this.chk_Format.CheckedChanged += new System.EventHandler(this.chk_Format_CheckedChanged);
			// 
			// chk_Diacritical
			// 
			...
			this.chk_Diacritical.CheckedChanged += new System.EventHandler(this.chk_Diacritical_CheckedChanged);
			// 
			// btn_Time
			// 
			this.btn_Time.Location = new System.Drawing.Point(143, 47);
			...
			// btn_Date
			// 
			this.btn_Date.Location = new System.Drawing.Point(200, 47);
			...
			// btn_Counter
			// 
			this.btn_Counter.Location = new System.Drawing.Point(71, 47);
			...
			// btn_Range
			// 
			this.btn_Range.Location = new System.Drawing.Point(259, 47);
			...
			// btn_Name
			// 
			this.btn_Name.Location = new System.Drawing.Point(7, 47);
			...
			// tbx_fileName
			// 
			this.tbx_fileName.Location = new System.Drawing.Point(44, 23);
			this.tbx_fileName.Name = "tbx_fileName";
			this.tbx_fileName.Size = new System.Drawing.Size(257, 20);
			...
			this.tbx_fileName.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.tbx_fileName_KeyPress);
			// 
			// tabControl1
			// 
			...
			this.aboutAuthorToolStripMenuItem.Size = new System.Drawing.Size(164, 22);
		...
		private System.Windows.Forms.Button btn_ChoosenColor;
		private System.Windows.Forms.Label label15;
		private System.Windows.Forms.Label label14;
		private System.Windows.Forms.TextBox tbx_PY;
		private System.Windows.Forms.TextBox tbx_PX;
		...
		private System.Windows.Forms.ComboBox cbx_FontStyle;
		...
		private System.Windows.Forms.CheckBox chk_Diacritical;
